export default {
  ...
  header: {
    img:
      process.env.PUBLIC_URL + '/assets/bg.jpg',
    imgPlaceholder:
  ...
  stack: {
    ...
    tech: [
      ...
      {
        img: process.env.PUBLIC_URL + '/assets/materialui.png',
        alt: 'materialui',
      }
      // {
    ...
    desc: ` I am a ReactJs enthusiast primarily focused on building frontend for Websites and Web apps. For adding styles to my React application I generally like to go for either Material UI, Tailwind Css or Sass `,
  },
  contact: {
    title: 'About Me',
    desc:
      "Hi there!. I am a Frontend Developer proficient in technlogies including ReactJS, Material UI, Tailwind Css, Sass to name a few. I am currently looking for a full time Web Development role so I can make use of my skills to build real world applications. If you are looking to hire, contact me on any of the platforms below.",
